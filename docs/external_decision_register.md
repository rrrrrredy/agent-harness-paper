...
| Artifact sharing mode | Resolved default | Public Zenodo artifact archive at `10.5281/zenodo.20907471`; working GitHub repository remains private unless separately opened. | Keep the GitHub release artifact aligned with the Zenodo-published archive and record any later versions as new releases. | `docs/artifact_release_index.md`, `docs/zenodo_release_plan.md`, `scripts/build_artifact_archive.py`, generated archive bundle |
