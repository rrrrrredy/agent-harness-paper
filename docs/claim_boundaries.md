...
- The committed Kimi result may be described only as a one-case live smoke, not as a full model or provider evaluation.
...
- General statistical superiority of one model or provider.
- That the 24 cases are representative of all production agent tasks.
- That static security scanning proves runtime safety.
