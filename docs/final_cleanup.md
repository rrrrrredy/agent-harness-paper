...
- `.\.venv\Scripts\python scripts\check_validate_workflow_paths.py`
...
- Confirm the checked PDF artifact can be downloaded with `gh run download 28217508824 -n agent-harness-paper-pdf -D logs\artifact-download`.
