...
- Future submission branches should be named by track, for example
  `submission/icse2027-tool-demo`, `submission/icse2027-nier`,
  `submission/saner2027-tool-demo`, and `submission/saner2027-short-paper`.
- Release tags should mark only externally shared versions, for example
  `v0.2.0-icse2027-tool-demo-submission` and
  `v1.0.0-camera-ready`.

## First-Principles Split

The work has two different submission shapes.

1. Public artifact tracks: ICSE Tool Demonstration and Data Showcase and SANER
   Tool Demo. These tracks can use the public GitHub repository, Zenodo DOI,
   author name, and YouTube video. The paper should sell a usable tool and data
   artifact, not a broad research claim.
...
|---|---:|---:|---|---|
| ICSE 2027 Tool Demonstration and Data Showcase | Single-anonymous | 4 pages, references included | Public GitHub, Zenodo, YouTube | Best immediate target |
